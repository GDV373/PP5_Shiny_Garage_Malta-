...
SECRET_KEY = os.environ.get('SECRET_KEY', 'fgdfbdfb')
...
SITE_NAME = 'ShinyGarageMalta.com'

ACCOUNT_EMAIL_SUBJECT_PREFIX = '[ShinyGarageMalta.com] '
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'shinygaragemalta'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'shinygaragemalta@gmail.com'
else:
